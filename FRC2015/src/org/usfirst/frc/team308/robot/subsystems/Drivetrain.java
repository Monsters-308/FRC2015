...
public class Drivetrain extends PIDSubsystem {
	...
	public Drivetrain() {
		...
		if (talonLF.getP() != talonRF.getP()
				|| talonLF.getI() != talonRF.getI()
				|| talonLF.getD() != talonRF.getD()) {
			talonRF.setPID(talonLF.getP(), talonLF.getI(), talonLF.getD(), 0,
					0, Globals.talonRampRate, 0);
			talonRB.setPID(talonLF.getP(), talonLF.getI(), talonLF.getD(), 0,
					0, Globals.talonRampRate, 0);
			talonLB.setPID(talonLF.getP(), talonLF.getI(), talonLF.getD(), 0,
					0, Globals.talonRampRate, 0);
		} else {
	...
	public void rotate(double angle) {
		...
		getPIDController().setPID(Globals.gyroI, 0, Globals.gyroP);
		getPIDController().enable();
		gyro.reset();
		Globals.userate = false;
		setSetpoint(angle);
	}

	public void normalgyro() {
		getPIDController().reset();
		getPIDController().setPID(Globals.gyroP, Globals.gyroI, Globals.gyroD);
		Globals.userate = true;
		setSetpoint(0);
		getPIDController().enable();
	}
