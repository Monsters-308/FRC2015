...
public class OI {
	...
	public OI() {
		...
		button5 = new JoystickButton(codriver, 5);
		button6 = new JoystickButton(codriver, 6);
		button9 = new JoystickButton(codriver, 9);
		button1.whenPressed(new CloseClaw());
		button1.whenReleased(new OpenClaw());
		button2.whenPressed(new ToggleClawTilt());
		button5.whenPressed(new ClawAdjust(true));
		button6.whenPressed(new ClawAdjust(false));
